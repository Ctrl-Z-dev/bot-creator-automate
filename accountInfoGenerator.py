...
def generatingName():
    ...
    surName = ["Demir", "Bala", "yilmaz", "Ediz", 				
		...
		"Avkar", "Ayana", "Alagan", "Akar","dinklebergskeptic","harleysjoker","shamilafan","hogwartssortinghat","lovebydaylight","honorarycrystalgem","rivervixen","bugheadlover","southsideserpent","geminitwin","mysticfall","stimberwolves","harrystyleslover","jobrofan","selena.fandom","teamedwardforever","endoftheline","waywardsisters","caosfan","nickbrinashipper"]
